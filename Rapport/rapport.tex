...
Notre problème étant une détection de contour, nous créons à partir des images d'entrée
des matrices composées de 0, 1, 2 et 3 : 0 pour le fond, 2 pour les axones, 3 pour
les dendrites, et 1 pour l'actine qui n'est ni axone, ni dendrite. Ainsi, nous
fournissons en entrée une matrice binaire, avec comme label une matrice composée
de 0, 1, 2 et 3.

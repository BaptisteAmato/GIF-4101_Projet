...
if __name__ == '__main__':
    ...
    # Load dataset.
    nb_images = 5
    X_train, Y_train, X_test, Y_test = load_dataset(nb_images)
    ...
    # Run the model.
    hist = myModel.fit(x=X_train, y=Y_train, validation_split=0.3, epochs=5, batch_size=3, callbacks=[checkpointer])
